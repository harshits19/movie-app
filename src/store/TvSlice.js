  ...
  async (genre) => {
    try {
      const res = await Promise.all([
        fetch(
          `https://api.themoviedb.org/3/discover/tv?with_genres=${genre}&sort_by=primary_release_date.desc`,
          fetch_options,
        ),
        fetch(
          `https://api.themoviedb.org/3/discover/tv?with_genres=${genre}&sort_by=popularity.desc`,
          fetch_options,
        ),
        fetch(
          `https://api.themoviedb.org/3/discover/tv?with_genres=${genre}&sort_by=vote_count.desc`,
          fetch_options,
        ),
        fetch(
          `https://api.themoviedb.org/3/discover/tv?with_genres=${genre}&sort_by=vote_average.desc`,
          fetch_options,
        ),
      ]);
