    ...
    <div className="bg-black">
      <div className="relative z-[1]">
        <div className="absolute left-0 right-0 m-auto flex h-20 max-w-[calc(100%-3rem)] items-center justify-between text-white sm:max-w-[calc(100%-4rem)] lg:h-[5.375rem] xl:max-w-[calc(83.3%-6rem)]">
          ...
          <div>
            <span className="m-2 h-20  p-2">English</span>
            <Link to="/login" className="no-underline">
              <span className="relative inline-flex cursor-pointer rounded  bg-ogRed px-4 py-[6px] text-[14px] font-medium transition-bgColor duration-250ms ease-ogTrans hover:bg-ogRedHover hover:ease-ogTransHover">Sign In</span>
            </Link>
          </div>
        </div>
      </div>
      <div className="relative flex h-full min-h-[30rem] justify-center pb-8 pt-[7.5rem] sm:min-h-[32rem] sm:pb-[3rem] sm:pt-[8.5rem] lg:min-h-[43.75rem] lg:pb-[4rem] lg:pt-[9.875rem]">
        ...
        <div className="m-auto flex max-w-[calc(100%-3rem)] flex-col items-center text-center text-white sm:max-w-[calc(100%-4rem)] xl:max-w-[calc(83.3%-6rem)]">
          <div className="relative basis-1/2">
            <div className="text-3xl font-bold lg:text-5xl">{LandingPageData["en"]?.mainSection?.title}</div>
            <div className="mt-4 text-lg font-medium sm:text-2xl sm:font-normal">{LandingPageData["en"]?.mainSection?.lineOne}</div>
            <div className="mt-4 text-lg font-medium sm:text-xl sm:font-normal">{LandingPageData["en"]?.mainSection?.lineTwo}</div>
            <div className="mx-auto my-0 max-w-[61.5rem] px-6 pt-6 sm:px-8">
              <form
                ...
                <div className="w-full min-w-[12rem] flex-auto bg-[#161616b3]">
                  <input name="email" type="email" placeholder={LandingPageData["en"]?.mainSection?.inputInnerText} className="w-full rounded  border border-solid border-[#808080b3] bg-transparent p-4 text-base font-normal text-white outline-none" ref={inputRef} />
                </div>
                <button
                  onClick={(e) => {
                    e.preventDefault()
      ...
      <div className="h-2 w-full bg-[#232323]"></div>
      <LandingPageSections data={LandingPageData["en"]?.infoSection[1]} first={"lg:order-1"} second={"lg:order-2"} />
      <div className="h-2 w-full bg-[#232323]"></div>
      <LandingPageSections data={LandingPageData["en"]?.infoSection[2]} />
      <div className="h-2 w-full bg-[#232323]"></div>
      <LandingPageSections data={LandingPageData["en"]?.infoSection[3]} first={"lg:order-1"} second={"lg:order-2"} />
      <div className="h-2 w-full bg-[#232323]"></div>
      <div className="h-full w-full bg-[#000000] py-14 text-center text-white lg:py-16">
        <div className="text-3xl font-bold lg:text-5xl">{LandingPageData["en"]?.faqSection?.title}</div>
        ...
        <div className="w-full px-6 pt-4 sm:px-10 lg:px-36">
          <div className="px-4 text-white sm:px-0 lg:px-14">
            <div className="mt-4 text-lg font-medium sm:text-xl sm:font-normal">{LandingPageData["en"]?.faqSection?.lineOne}</div>
            <div className="mx-auto my-0 max-w-[61.5rem] px-6 pt-6 sm:px-8">
              <form
                className="relative mx-auto flex w-full max-w-[36.625rem] flex-col items-center gap-y-4 sm:flex-row sm:gap-y-0"
                onSubmit={(e) => {
                ...
                <div className="w-full min-w-[12rem] flex-auto bg-[#161616b3]">
                  <input name="email" type="email" placeholder={LandingPageData["en"]?.faqSection?.inputInnerText} className="w-full rounded  border border-solid border-[#808080b3] bg-transparent p-4 text-base font-normal text-white outline-none" ref={inputRefTwo} />
                </div>
                <button
                  onClick={(e) => {
                    e.preventDefault()
      ...
      <div className="h-full w-full bg-[#000000] py-10 text-left text-white lg:py-16">
        <div className="mx-auto max-w-[calc(100%-3rem)] sm:max-w-[calc(100%-4rem)] xl:max-w-[calc(83.3%-6rem)]">
          <div className="font-medium text-[#ffffffb3]">
            ...
            <span className="cursor-pointer underline">{LandingPageData["en"]?.footerSection?.titleSub}</span>
          </div>
          <div className="flex cursor-pointer flex-col justify-start py-4 text-sm text-[#ffffffb3] underline sm:flex-row">
            {LandingPageData["en"]?.footerSection?.sections?.map((items, idx) => {
              return (
          ...
          <div className="text-sm text-[#ffffffb3]">{LandingPageData["en"]?.footerSection?.websiteTitle}</div>
        </div>
      </div>
    </div>
  )
