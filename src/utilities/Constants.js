      ...
      accordionData: [
        {
          ...
          id: 1,
          description:
            "Netflix एक स्ट्रीमिंग सेवा है जो इंटरनेट से जुड़े हजारों डिवाइस पर विभिन्न पुरस्कार जीतने वाले टीवी शो, मूवीज, एनिमे, डॉक्यूमेंट्री और अधिक की विभिन्न वराइटी प्रदान करता है।\n\nआप चाहें तो जब चाहें, जितना चाहें, बिना एक भी विज्ञापन के देख सकते हैं - सब कुछ एक ही कम मासिक कीमत पर। हमेशा कुछ नया खोजने के लिए कुछ होता है, और नई टीवी शो और मूवीज हर हफ्ते जोड़ी जाती हैं",
        },
        {
        ...
        },
        {
          ...
          id: 3,
          description:
            "कहीं भी, कभी भी देखें। अपने Netflix खाते में साइन इन करें और अपने व्यक्तिगत कंप्यूटर पर netflix.com पर या जोड़े गए Netflix ऐप का उपयोग करने वाले किसी भी इंटरनेट संचालित डिवाइस पर तुरंत देखने के लिए।\n\nआप iOS, Android, या Windows 10 ऐप के साथ अपने पसंदीदा शो को डाउनलोड भी कर सकते हैं। डाउनलोड का उपयोग करके जब भी आप बाहर जा रहे हैं और बिना इंटरनेट कनेक्शन के देखने के लिए करें। Netflix को कहीं भी ले जाएँ",
        },
        {
        ...
        },
        {
          ...
          id: 6,
          description:
            "Netflix Kids अनुभव आपकी सदस्यता में शामिल है ताकि माता-पिता को नियंत्रण हो और बच्चे अपने पसंदीदा टीवी शो और फ़िल्मों का आनंद अपने खुद के अंतर्निहित अंतरिक्ष में उठा सकें।\n\nबच्चों के प्रोफ़ाइल पर पिन से सुरक्षा प्रबंधित माता-पिता नियंत्रण आता है, जो आपको सामग्री के परिपर्णता रेटिंग को प्रतिबंधित करने और बच्चों को देखने के लिए कुछ खास शीर्षकों को ब्लॉक करने की अनुमति देता है",
        },
      ],
    },
    footerSection: {
...
export const AuthPageData = {
  ...
  hi: {
    formSection: {
      ...
      validatorText: {
        name: "आपका नाम 4 से 60 वर्णों के बीच होना चाहिए।",
        email: "कृपया एक मान्य ईमेल पता या फ़ोन नंबर दर्ज करें।",
        password: "आपका पासवर्ड 4 से 60 वर्णों के बीच होना चाहिए।",
      },
      rememberMeBtnText: "मुझे याद रखें",
      needhelpBtnText: "मदद चाहिए?",
      formSwitchText: {
        signin: "Netflix पर नए हैं? ",
        signin2: "अब साइन अप करें",
